...
if("TRUE" STREQUAL "TRUE")
  set(localization_data_pub_SOURCE_PREFIX /home/ibraam/catkin_ws/src/jetson_nano_bot/localization_data_pub)
  set(localization_data_pub_DEVEL_PREFIX /home/ibraam/catkin_ws/devel)
  ...
  set(localization_data_pub_INSTALL_PREFIX /home/ibraam/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ibraam <ibraam@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization_data_pub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ibraam/catkin_ws/src/jetson_nano_bot/localization_data_pub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ibraam/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND localization_data_pub_EXPORTED_TARGETS ${${localization_data_pub_dep}_EXPORTED_TARGETS})
endforeach()
